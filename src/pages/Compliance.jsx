            ...
            <div className='w-full grid grid-cols-1 md:grid-cols-3 gap-4 lg:gap-10 pb-5 overflow-hidden' style={{ background: 'rgba(30, 30, 30, 0.95)' }}>
                <div className='px-2 md:pr-0 md:pl-12 xl:pl-20 py-14 lg:pb-0 lg:pt-20 xl:pt-40 col-span-1 md:col-span-2 text-[#fff] order-1 md:order-none'>
                    <div className='flex items-end leading-none pl-4 md:pl-8' data-aos='fade-right' data-aos-duration='1000'>
                        <h1 className='text-[20px] lg:text-[30px] text-gradient font-[700] text-start text-line w-[600px] lg:w-[500px]' data-aos='fade-right' data-aos-duration='1500'>{ t("compliances_duties") }</h1>
            ...
            <div className='w-full grid grid-cols-1 md:grid-cols-3 gap-4 lg:gap-10 pb-20 overflow-hidden' style={{ background: 'rgba(30, 30, 30, 0.95)' }}>
                ...
                <div className='px-2 md:pl-0 md:pr-12 xl:pr-20 py-14 lg:pb-0 lg:pt-20 xl:pt-40 col-span-1 md:col-span-2 text-[#fff] order-3 md:order-none'>
                    <div className='flex items-end leading-none pl-4 md:pl-8'>
                        <h1 className='text-[20px] lg:text-[30px] text-gradient font-[700] text-start text-line w-[600px] lg:w-[500px]' data-aos='fade-left' data-aos-duration='1500'>{ t("compliances_duties") }</h1>
                        <hr className='w-full ml-1' style={{ height: '4px', border: 'none', background: 'linear-gradient(90deg, #EBB81B 0%, #DFAD16 45.5%, #FAF088 100%)' }} />
                    </div>
                    ...
                    <button data-aos='fade-left' data-aos-duration='1500' className='ml-4 md:ml-0 mt-6 text-[#FFD700] font-[600] px-8 py-2 border-2 border-[#FFD700] rounded-[30px] text-[12px] md:text-[13px]"'
